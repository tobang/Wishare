...
# General Guidelines for working with Wishare Appwrite API

- You have access to the Appwrite api MCP server (appwrite-api) and its tools, use the to help the user.
- Notify me every time you are using the Appwrite api MCP server.
